...
(function () {
  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    const it = {
      ...
      maps_title: 'Mappe della Croazia',
      maps_sub: 'Confini politici, paesi vicini e viste del terreno fisico della Croazia',
      ...
      map_physical_title: 'Mappa Fisica',
      map_physical_p: 'La vista fisica mette in evidenza le montagne costiere, l\'entroterra carsico e collinare e le fertili pianure orientali che si estendono verso il Danubio.',
      ...
      eco_tab_primary: 'Settore Primario',
      eco_tab_secondary: 'Settore Secondario',
      eco_tab_tertiary: 'Settore Terziario',
      eco_tab_tourism: 'Turismo',
    ...
    const hr = {
      ...
      maps_title: 'Karte Hrvatske',
      maps_sub: 'Političke granice, susjedne zemlje i fizičke karte Hrvatske',
      ...
      map_physical_title: 'Fizička karta',
      map_physical_p: 'Fizička karta ističe obalne planine, krška i brdovita područja te plodne istočne ravnice koje se protežu prema Dunavu.',
      geo_c1_h: 'Reljef',
      ...
      eco_tab_primary: 'Primarni sektor',
      eco_tab_secondary: 'Sekundarni sektor',
      eco_tab_tertiary: 'Tercijarni sektor',
      eco_tab_tourism: 'Turizam',
      ...
      cur_c11_p: 'Nevera tvrtke Rimac Automobili postala je najbrzi serijski električni hiperautomobil na svijetu, ubrzavajući 0–100 km/h za 1,97 sekundi i postavljajući brzinske probe na hrvatskim cestama i pistama.',
